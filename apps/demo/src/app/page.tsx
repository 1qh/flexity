...
const { Grid, Panel } = createGrid(),
  demoConfig = {
    gap: 16,
    layout: [
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', key: 'kpi', w: 400 },
      ...
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', h: 350, key: 'bar', w: 600 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', h: 350, key: 'line', w: 600 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', h: 350, key: 'area', w: 600 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', h: 300, key: 'pie', w: 400 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', h: 300, key: 'radar', w: 400 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', h: 300, key: 'radial', w: 400 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', key: 'table', w: 800 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', key: 'progress', w: 400 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', key: 'timeline', w: 400 },
      ...
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', key: 'tabs', w: 500 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', key: 'accordion', w: 500 },
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', key: 'form', w: 400 },
      ...
      { className: 'flex flex-col gap-2 rounded-lg border border-border bg-card p-4', key: 'skeleton', w: 400 },
